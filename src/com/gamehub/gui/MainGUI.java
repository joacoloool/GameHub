...
public class MainGUI extends JFrame {
    ...
    public MainGUI(Manager manager, User selectedProfile) {
        initComponents();
        this.selectedProfile = selectedProfile;
        libraryGUI = new LibraryGUI(selectedProfile);
        profileGUI = new ProfileGui(manager, manager.getUserByName(selectedProfile.getName()));
